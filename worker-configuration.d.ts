/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 13a63eb7263f4d43abd2b8cc474a5d0e)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTHORIZATION_KEY">> {}
}
